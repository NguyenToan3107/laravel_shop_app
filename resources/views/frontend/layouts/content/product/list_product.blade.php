    ...
    <div class="product-grid">
        ...
        <div class="showcase">
            ...
            <div class="showcase-banner">
                ...
                <img src="{{asset('assets/frontend/images/products/jacket-3.jpg')}}" alt="Mens Winter Leathers Jackets"
                     width="300" class="product-img default">
                <img src="{{asset('assets/frontend/images/products/jacket-4.jpg')}}" alt="Mens Winter Leathers Jackets"
        ...
        <div class="showcase">
            ...
            <div class="showcase-banner">
                <img src="{{asset('assets/frontend/images/products/shirt-1.jpg')}}" alt="Pure Garment Dyed Cotton Shirt"
                     class="product-img default"
                     width="300">
                <img src="{{asset('assets/frontend/images/products/shirt-2.jpg')}}" alt="Pure Garment Dyed Cotton Shirt"
        ...
        <div class="showcase">
            ...
            <div class="showcase-banner">
                <img src="{{asset('assets/frontend/images/products/jacket-5.jpg')}}"
                     ...
                     width="300">
                <img src="{{asset('assets/frontend/images/products/jacket-6.jpg')}}"
