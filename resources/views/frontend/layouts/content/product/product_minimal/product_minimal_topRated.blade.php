<div class="showcase-wrapper  has-scrollbar">
    ...
    <div class="showcase-container">
        ...
        <div class="showcase">
            ...
            <a href="#" class="showcase-img-box">
                <img src="{{asset('assets/frontend/images/products/watch-3.jpg')}}"
        ...
        <div class="showcase">
            ...
            <a href="#" class="showcase-img-box">
                <img src="{{asset('assets/frontend/images/products/jewellery-3.jpg')}}"
        ...
        <div class="showcase">
            ...
            <a href="#" class="showcase-img-box">
                <img src="{{asset('assets/frontend/images/products/perfume.jpg')}}"
        ...
        <div class="showcase">
            ...
            <a href="#" class="showcase-img-box">
                <img src="{{asset('assets/frontend/images/products/belt.jpg')}}"
    ...
    <div class="showcase-container">
        ...
        <div class="showcase">
            ...
            <a href="#" class="showcase-img-box">
                <img src="{{asset('assets/frontend/images/products/jewellery-2.jpg')}}"
        ...
        <div class="showcase">
            ...
            <a href="#" class="showcase-img-box">
                <img src="{{asset('assets/frontend/images/products/watch-1.jpg')}}"
